...
# Data parameters
PATH_INPUT=data/preprocessed_dWt_stats_12to18_train.csv
PATH_INPUT_TEST=data/preprocessed_dWt_stats_12to18_test.csv
PATH_OUTPUTS_DIR=outputs/depad
COLUMN_TARGET=SMFQdepressionscoreabovecutoffatanypointfromage12to18
