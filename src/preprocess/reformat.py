...
# DEFAULT_RAW_DATA = '../../data/Merged_04_05_21_nomissing_cleanDep.csv'
DEFAULT_RAW_DATA = '../../data/small.csv'
DEFAULT_MAPPING = '../../data/variable_mapping.txt'
...
def map_variables(df_data: pd.DataFrame, df_mapping: pd.DataFrame) -> pd.DataFrame:
    ...
    original_variables_without_mapping = df_mapping_missing['original_variable_name'].tolist()
    logger.warning(
...
def reformat_data(
        ...
        output_file: str,
        num_workers: int,
        child_id_column_name: str = '_CH_ID_0d') -> None:
    """
    """
...
def main():
    ...
    # read name mapping data
    df_name_mapping = pd.read_csv(args.mapping_data, sep='\t')
